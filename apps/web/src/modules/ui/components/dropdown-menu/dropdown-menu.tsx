...
>(({ className, inset, children, ...props }, ref) => (
  <DropdownMenuPrimitive.SubTrigger
    ref={ref}
    className={cn(
      'flex cursor-default select-none items-center rounded-sm px-2 py-1.5 text-sm outline-none focus:bg-neutral-50 data-[state=open]:bg-neutral-50',
      inset && 'pl-8',
      className
    )}
    {...props}
  >
    {children}
    <svg
      className="ml-auto h-5 w-5 stroke-black dark:stroke-white"
